...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="post_to_let.html">Post To-Let</a>
    ...
    ?>
        ...
        <table align="center">
            <tr>
                <td>
                    <?php
                       echo '<img src="'.$image.'" alt="HTML5 Icon" style="width:300px;height:212px;">';
                    ?>
                </td>
                <div class="postd">
            ...
            echo "<strong>"."No of Room: "."</strong>".$result['room']."&nbsp;&nbsp;&nbsp;&nbsp;";
            echo "<strong>"."Washroom: "."</strong>".$result['washroom']."&nbsp;&nbsp;&nbsp;&nbsp;";
        ...
        <?php
            ...
            ?>
            <br/>
            <form action="../view_details/view_details.php" method="post">
